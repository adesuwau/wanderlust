...
t4 = Trip.create(trip_name: 'Making Waves in Morooco', trip_date: '1/2/14 - 1/10/14', description: 'Loren Ipsum Blah Blah', fave_memory: 'Random random random', photo: 'http://www.bikehike.com/files/styles/destination-list-view/public/destination/Morocco-Adventure-Travel_0.jpg')
t1.city_id = ci1.id
t1.save
t1.user_id = u1.id
t1.save
